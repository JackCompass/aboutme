            ...
            <Header>
                <div className={styles.section__info}>
                    ...
                    <p className={styles.section__description}>
                        In my free time I like to read, create and tinker with new technologies.
                        Sometimes I find myself finding some patterns, techniques and ideas that I can leverage in my work.
                        I like to share them with others so that they can benefit from them.
                    </p>
