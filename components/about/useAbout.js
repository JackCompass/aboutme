...
import {discoveryFilesData, discoveryFilesList, filesPreviewData, previewFilesList} from "../../state/atom";
...
const useAbout = () => {
    ...
    const {
        data: discoveriesContent,
        error: discoveriesContentError
    } = useSWR(getDiscoverFilesList.length !== 0 ? "repositoryDiscoveryRepoContent" : null, () => Repository.getRepositoryFileContent(getDiscoverFilesList));
